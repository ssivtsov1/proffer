...
<div class="site-login">
    ...
    <div class="row row_proffer">
        <div class="col-lg-6">
            <?php $form = ActiveForm::begin(['id' => 'inputcomplaint',
                'options' => [
            ...
            <?= $form->field($model, 'name_p')->textarea(['rows' => 1, 'cols' => 25,
                'onDblClick' => 'rmenu($(this).val(),"#complaint-name_p")']) ?>
            <div class='rmenu' id='rmenu-complaint-name_p'></div>
            ...
            <?= $form->field($model, 'text')->textarea(['rows' => 7, 'cols' => 25,
                'onDblClick' => 'rmenu($(this).val(),"#complaint-text")']) ?>
             <div class='rmenu' id='rmenu-complaint-text'></div>  
...
<script>
    function showfields(p){
            if (p == 0) {
                $('.field-complaint-name_p').hide();
                $('.field-complaint-email').hide();
                $('.field-complaint-tel').hide();
                $('.field-complaint-send_result').show();
                $(".field-complaint-name_p").slideDown("slow");
                $('.field-complaint-email').slideDown("slow");
                $('.field-complaint-tel').slideDown("slow");
            }
            else {
                $('.field-complaint-name_p').show();
                $('.field-complaint-email').show();
                $('.field-complaint-tel').show();
                $('.field-complaint-send_result').hide();
                
                $(".field-complaint-name_p").slideUp("slow");
                $('.field-complaint-email').slideUp("slow");
                $('.field-complaint-tel').slideUp("slow");        
            }
    }
