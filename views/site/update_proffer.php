...
window.addEventListener('load', function(){
          var t= $("#vproffer-name_p").val();
          if (t=='Анонім') {
                $(".field-vproffer-tab_nom").hide();
                $(".field-vproffer-main_unit").hide();
                $(".field-vproffer-unit_1").hide();
                $(".field-vproffer-unit_2").hide();
                $(".field-vproffer-post").hide();
                $(".field-vproffer-tel_mob").hide();
                $(".field-vproffer-tel_in").hide();
                $(".field-vproffer-tel_town").hide(); 
                $(".field-vproffer-email").hide(); 
                $(".field-vproffer-email_spr").hide();
                $(".field-vproffer-email_group").hide(); 
          }
