...
$this->title = 'Перегляд пропозицій';
...
<div class="site-spr1">
    ...
    <span class="ex-find"> 
        <?= Html::a(' Розширений пошук',["exfind?mode=2"], ['class' => 'btn btn-default glyphicon glyphicon-search']); ?></span>
        ...
        'columns' => [
            ...
            'buttons'=>[
                ...
                'update'=>function ($url, $model) {
                    $customurl=Yii::$app->getUrlManager()->createUrl(['/site/upd_proffer','id'=>$model['id'],'mod'=>'proffer']); //$model->id для AR
